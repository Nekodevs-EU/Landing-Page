  ...
  <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
    <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
      ...
      <div class="mt-10 flex items-center gap-x-6">
        <a href="#" class="rounded-md bg-purple-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-purple-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">Our projects</a>
        <a href="#" class="text-sm font-semibold leading-6 text-white">Who's behind this? <span aria-hidden="true">→</span></a>
      </div>
    </div>
...
<section class="bg-gradient-to-r from-purple-900 to-indigo-900 py-16 dark:bg-gray-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div class="p-6 bg-gray-800 dark:bg-gray-700 rounded-lg shadow-lg">
                ...
                <a href="https://github.com/french-femboi" class="mt-4 text-base text-purple-500 hover:text-purple-400">View Profile</a>
            </div>
            <div class="p-6 bg-gray-800 dark:bg-gray-700 rounded-lg shadow-lg">
                <div class="flex items-center justify-center h-24 w-24 rounded-full bg-purple-600">
                ...
                <p class="mt-2 text-base text-gray-300 dark:text-gray-500">Developer</p>
                <a href="https://github.com/elpoeprod" class="mt-4 text-base text-purple-500 hover:text-purple-400">View Profile</a>
            </div>
        </div>
    </div>
</section>
